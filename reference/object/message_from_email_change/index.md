...
An Message in Groove that was created as a result of an incoming email.

Both Customers and Agents can author these type of messages. For
example, if an Agent replies directly to a Customer (possibly using a
Groove notification email), then Groove will register the Agent's email
response as a MessageFromEmailChange.
